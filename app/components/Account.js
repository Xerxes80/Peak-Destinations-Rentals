...
//<div className="main-container">
      ...
      //         <h2 className="text-center"><strong>ACCOUNT</strong></h2>
      //         <hr />
      //         <button type="button" className="btn btn-primary" data-toggle="modal" data-target="#signUpModal" data-whatever="SignUp">Sign Up</button>
      //         <button type="button" className="btn btn-primary" data-toggle="modal" data-target="#signInModal" data-whatever="SignIn">Sign In</button>
      //         <hr />
      //       </div>
      //       <div>
      //         <h2>Reservations</h2>
      ...
      //                     <h5 className="modal-title" id="exampleModalLabel">Sign Up Modal</h5>
      ...
      //                 <div className="modal-content">
      //                   <div className="modal-header">
      //                     <h5 className="modal-title" id="exampleModalLabel">Sign In Modal</h5>
      //                     <button type="button" className="close" data-dismiss="modal" aria-label="Close">
      //                       <span aria-hidden="true">&times;</span>
      //                     </button>
      //                   </div>
